...
compatibility. The summary intentionally omits raw stdout/stderr and sensitive ignored path labels;
review the uploaded `report.html`, `summary.json`, and `manifest.json` for full offline receipt
details.
